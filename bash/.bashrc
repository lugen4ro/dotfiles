...
# make ctrl-d safer (require 2 EOF to close terminal)
# =1 ignores 1 EOF so 2 are needed to exit
IGNOREEOF=1


# powerline
# /home/gen4ro/.local/lib/python3.10/site-packages/powerline/bindings/bash/powerline.sh
